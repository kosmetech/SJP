...
public class Adapter_Scan extends RecyclerView.Adapter<Adapter_Scan.ViewHolder> {
    ...
    @NonNull
    @Override
    public Adapter_Scan.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_Scan.ViewHolder holder, int position) {
